...
const translations: Record<Language, Record<string, string>> = {
  tr: {
    ...
    'hero.badge': 'Tıbbi Sınıf AI Platformu',
    'hero.title1': 'AI Destekli',
    'hero.title2': 'Yüz',
    'hero.title3': 'Rekonstrüksiyon',
    'hero.subtitle': 'Sağlık profesyonelleri için gelişmiş görüntü analizi ve <strong>lokal flep planlaması</strong>',
    'hero.description': 'Keskin AI teknolojisi ile tıbbi uzmanlığı birleştiriyoruz',
  ...
  en: {
    ...
    'nav.signIn': 'Sign In',
    'hero.badge': 'Medical-Grade AI Platform',
    'hero.title1': 'AI-Powered',
    'hero.title2': 'Facial',
    'hero.title3': 'Reconstruction',
    'hero.subtitle': 'Advanced vision analysis and <strong>local flap planning</strong> for healthcare professionals',
    'hero.description': 'Combining cutting-edge AI technology with medical expertise',
