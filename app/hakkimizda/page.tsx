        ...
        <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
          <div className="divide-y divide-slate-100">
            ...
            <div className="p-6 sm:p-8">
              <div className="flex items-start gap-3 mb-3">
                ...
                <h2 className="text-xl font-semibold text-slate-900">{t('about.purposeTitle')}</h2>
              </div>
              <div className="text-slate-600 leading-relaxed pl-8 space-y-3">
                <p>{t('about.purposeText1')}</p>
                <p>{t('about.purposeText2')}</p>
              </div>
            </div>
            ...
            <div className="p-6 sm:p-8">
              <div className="flex items-start gap-3 mb-3">
                ...
                <h2 className="text-xl font-semibold text-slate-900">{t('about.audienceTitle')}</h2>
              </div>
            ...
            <div className="p-6 sm:p-8">
              <div className="flex items-start gap-3 mb-3">
                ...
                <h2 className="text-xl font-semibold text-slate-900">{t('about.kvkkTitle')}</h2>
              </div>
              <p className="text-slate-600 leading-relaxed pl-8">
                {t('about.kvkkText')}
              </p>
            ...
            <div className="p-6 sm:p-8">
              <div className="flex items-start gap-3 mb-3">
                ...
                <h2 className="text-xl font-semibold text-slate-900">{t('about.techTitle')}</h2>
              </div>
              <p className="text-slate-600 leading-relaxed pl-8">
                {t('about.techText')}
              </p>
          ...
          <div className="mx-6 mb-6 sm:mx-8 sm:mb-8 rounded-lg border-l-4 border-amber-500 bg-amber-50 p-5">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-base font-semibold text-slate-900 mb-1">{t('about.legalTitle')}</h3>
